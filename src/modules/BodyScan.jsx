...
const STEPS = [
  { part: '정수리', y: 5, line: '머리 꼭대기부터 시작할게요. 정수리의 힘을 천천히 풀어요.' },
  ...
  { part: '팔과 손', y: 44, line: '팔을 따라 손끝까지 내려가요. 팔이 무거워지고, 손도 부드럽게 풀려요.' },
  { part: '가슴', y: 46, line: '가슴으로 내려와요. 숨이 천천히 오르내리는 걸 가만히 느껴 봐요.' },
  { part: '배', y: 56, line: '배로 내려와요. 배가 부드러워지고, 따뜻하게 풀려요.' },
  { part: '허리와 등', y: 64, line: '등과 허리를 지나가요. 바닥에 닿은 등이 무겁게 가라앉아요.' },
  { part: '골반', y: 71, line: '이제 골반으로 내려와요. 몸을 받치던 힘을 다 내려놓아요.' },
  { part: '다리', y: 83, line: '허벅지와 다리를 따라 내려가요. 다리가 점점 무거워져요.' },
  { part: '발', y: 96, line: '발끝까지 다 내려왔어요. 온몸의 힘이 부드럽게 풀렸어요.' },
]
